...
public class ItemContoller {
    ...
    public ResponseEntity<ResultResponse> createItem(@Valid @RequestBody ItemRequest itemRequest,
        /*@AuthenticationPrincipal UserDetailsImpl userDetails*/User user){
        return ResponseEntity
            .status(HttpStatus.CREATED)
            .body(itemService.createItem(itemRequest, user));
    }
    ...
    public ResponseEntity<ResultResponse> updateItem(@PathVariable Long itemId, @RequestBody ItemRequest itemRequest,
        /*@AuthenticationPrincipal UserDetailsImpl userDetails*/User user){
        return ResponseEntity
            .status(HttpStatus.CREATED)
            .body(itemService.updateItem(itemId, itemRequest, user));
    }
    ...
    public ResponseEntity<ResultResponse> deleteItem(@PathVariable Long itemId,
        ...
        return ResponseEntity
            ...
            .body(itemService.deleteItem(itemId, user));
    }
